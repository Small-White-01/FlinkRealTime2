...
public class DwdTradeRefundDetail {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //读order_detail,读refund_info
        // TODO 3. 从 Kafka 读取 topic_db 数据，封装为 Flink SQL 表
        tableEnv.executeSql(MyKafkaUtil.getTopicDB()
                + MyKafkaUtil.getKafkaDDLConnectors("topic_db", "dwd_trade_order_refund"));
        ...
        Table resultTable = tableEnv.sqlQuery("select \n" +
                ...
                "left join \n" +
                "my_base_dic for system_time as of ri.proc_time as type_dic\n" +
                "on ri.refund_type = type_dic.dic_code\n" +
                "left join\n" +
                "my_base_dic for system_time as of ri.proc_time as reason_dic\n" +
        ...
        tableEnv.executeSql("create table dwd_trade_order_refund(\n" +
                ...
                ")" + MyKafkaUtil.getUpdateKafkaDDLConnectors("dwd_trade_order_refund"));

        // TODO 9. 将关联结果写入 Upsert-Kafka 表
        tableEnv.executeSql("" +
                "insert into dwd_trade_order_refund select * from result_table").print();
